...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para el amor de mi vida kiara:\n\nWow como fue la manera que nos conocimos, de ser una desconocida... hacer una de las personas más importante de mi vida.\n\nGracias por hacer mis dias más felices, de hacerme reir, tu sonriza, la expresión uff cada vez que te gusta algo y sobre todo lo enana que eres...toda esas cosas hicieron que seas una persona muy importante para mí.\n\nTe amo más de lo que las palabras pueden expresar.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con todo mi amor, tu alto Edu";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `El día que todo cambio: <b>${days}</b> días<br>` +
